...
param privateDnsZoneAcrName = 'privatelink${environment().suffixes.acrLoginServer}'
param privateDnsZoneKvName = 'privatelink.vaultcore.azure.net'
param privateDnsZoneSaName = 'privatelink.file.${environment().suffixes.storage}'
param storageAccountName = 'st${uniqueString('aks', uniqueString(subscription().id, utcNow()))}'
