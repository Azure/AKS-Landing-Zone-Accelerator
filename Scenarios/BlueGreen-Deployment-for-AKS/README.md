...
The proposed pattern comes also with a Reference Architecture document located in [Deployment](../AKS-Secure-Baseline-PrivateCluster/Terraform/11-blue-green.md).